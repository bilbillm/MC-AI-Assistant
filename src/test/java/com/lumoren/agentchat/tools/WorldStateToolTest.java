...
/**
 * Unit tests for {@link WorldStateTool}.
 */
class WorldStateToolTest {

    private final WorldStateTool tool = new WorldStateTool();

    @Test
    void getName_returnsCorrectName() {
        assertEquals("get_world_state", tool.getName());
    }
    ...
    void getDefinition_returnsValidDefinition() {
        ...
        assertEquals("get_world_state", def.name());
    ...
    void execute_withMockMinecraft_doesNotThrow() {
        ...
        try {
            ...
            assertEquals("get_world_state", result.toolCallId());
        } catch (Exception e) {
